...
public class ConnectionFactory {
	...
	// gets
	/*
	 * Desc: é um método estático que permite obter uma única instância de
	 * ConnectionFactory. Ele carrega as informações de configuração do arquivo
	 * application.properties e cria uma única instância da classe com base nesses
	 * valores. Se uma instância já existir, ela a retorna.
	 * 
	 * @author: Rodrigo
	 */
